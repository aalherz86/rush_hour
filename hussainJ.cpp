...
int updatedScores (int argc, char *argv[]) {
    ...
    BIO *outbio = NULL;
//---------------------------------------------------------------------
//Fixed warning: const added before SSL_METHOD
//Previous code was:
//   SSL_METHOD *method
//---------------------------------------------------------------------
...
//---------------------------------------------------------------------
//Fixed warning: In this step I have added if parabthesis
//Previous code was:
//   if (ret <= 0)
//   	fprint(stderr, "ERROR: SS:_write\n"); fflush(stderr);
//---------------------------------------------------------------------
    if (ret <= 0) {	// In here we have added a parenthesis
